package com.gbss.nature.configuration;
...
public class SwaggerConfiguration {
	...
	public OpenAPI usersMicroserviceOpenAPI() {
		...
		contact.setEmail("gaganvdeveloper@gmail.com");
		contact.setName("Pure Nature Jaggery");
		contact.setUrl("http://nature.us-east-1.elasticbeanstalk.com/");
		License mitLicense = new License().name("MIT License").url("https://choosealicense.com/licenses/mit/");
		Info info = new Info().title("Pure Nature Jaggery Application RESTful Web Service documentation").version("1.0")
